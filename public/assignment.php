...
<link rel="stylesheet" href="../css/assigncss.css">
...
<nav class="navClass">
	<ul>
		...
		<li><a id="bar" href="assignment2.php">Change Contrast</a></li>
...
<br><br><br><br>
		<div class="outside">
		<div class="inside" >
			<div class="mini" >Lab1</div>
			<div class="mini" >Deadline<br>01/09/19</div>
			<div class="mini" >Submitted</div>
		</div>
		<div class="inside">
			<div class="mini" >Lab2</div>
			<div class="mini" >Deadline<br>01/20/19</div>
			<div class="mini" >Submitted</div>
		</div>
		<div class="inside">
...
<script>
	...
	"use strict";
	var lhs = document.querySelector("left");
	var rhs = document.querySelector("right");
